import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,e as a}from"./app-bd8f263d.js";const i={},l=a(`<div class="hint-container tip"><p class="hint-container-title">✨✨✨✨✨</p><p>在Linux上如何设置shell脚本开机启动</p></div><ol><li><p>赋予 <code>/etc/rc.d/rc.local</code> 可执行权</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">chmod</span> +x /etc/rc.d/rc.local
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,6),c=[l];function t(o,d){return n(),e("div",null,c)}const u=s(i,[["render",t],["__file","boot-up-script.html.vue"]]);export{u as default};
