...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li><li><p>重启服务器，查看nginx是否自启动</p></li></ol>`,7),t=[l];function r(c,p){return s(),a("div",null,t)}const v=n(i,[["render",r],["__file","installation-nginx.html.vue"]]);export{v as default};
