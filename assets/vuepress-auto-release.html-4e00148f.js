import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as r,c as p,a as d,b as s,d as n,e,w as l,f as a}from"./app-203f50af.js";const u="/assets/1650815065456-59ccda38.png",m="/assets/1650815121716-b3247b9d.png",v="/assets/1650815644534-72064f5f.png",b="/assets/1650816202369-dc839133.png",g="/assets/1650816306998-bede7e96.png",h="/assets/1650816400767-5e9db4af.png",k="/assets/1650816444025-f4401e84.png",f="/assets/1650817147035-f9c67a3e.png",_="/assets/1650817330415-1e1767f1.png",x="/assets/1650817479415-1d04a43c.png",y={},q=s("div",{class:"hint-container tip"},[s("p",{class:"hint-container-title"},"✨✨✨✨✨"),s("p",null,"通过gitee仓库的WebHook回调实现VuePress项目的自动化部署")],-1),w={id:"在linux上部署vuepress",tabindex:"-1"},C=s("a",{class:"header-anchor",href:"#在linux上部署vuepress","aria-hidden":"true"},"#",-1),z=a(`<h2 id="新建脚本文件" tabindex="-1"><a class="header-anchor" href="#新建脚本文件" aria-hidden="true">#</a> 新建脚本文件</h2><ol><li><p>在VuePress项目根目录中新建shell脚本文件 <code>start.sh</code></p></li><li><p>编辑start.sh脚本文件并上传至git仓库</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>  <span class="token comment">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li><li><p>配置git仓库的WebHook，使其在推送代码时自动触发接口(此处以gitee为例)</p><p><img src="`+f+'" alt="配置webhook" title="配置webhook" loading="lazy"><br> 6. 配置webhook的回调地址</p><figure><img src="'+_+'" alt="配置接口回调地址" tabindex="0" loading="lazy"><figcaption>配置回调地址</figcaption></figure><ol start="7"><li><p>测试效果</p><figure><img src="'+x+'" alt="效果" tabindex="0" loading="lazy"><figcaption>效果</figcaption></figure><p><strong>返回执行成功，说明脚本已成功执行，之后提交代码时，便会通过webhook回调接口去触发脚本的执行，从而实现vuepress的自动发布</strong></p></li></ol></li>',3),S=s("h2",{id:"设置项目开机启动",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#设置项目开机启动","aria-hidden":"true"},"#"),n(" 设置项目开机启动")],-1),V=a(`<li><p>在linux服务器root目录下新建start.sh脚本</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
<span class="token comment"># 切入源码目录，以确保能正常执行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>`,1);function $(L,P){const i=t("RouterLink"),o=t("ExternalLinkIcon");return r(),p("div",null,[q,d(" more "),s("h2",w,[C,n(),e(i,{to:"/about-this-website/vuepress-release.html"},{default:l(()=>[n("在Linux上部署VuePress")]),_:1})]),z,s("p",null,[s("strong",null,[s("a",E,[n("此处以Asp.Net"),e(o)]),n(" Core Web Api为例")])]),I,s("ol",null,[N,s("li",null,[s("p",null,[e(i,{to:"/articles/linux/installation-dotnet.html"},{default:l(()=>[n("在Linux上安装.Net6环境")]),_:1})])]),D]),S,s("ol",null,[V,s("li",null,[s("p",null,[e(i,{to:"/articles/linux/boot-up-script.html"},{default:l(()=>[n("在Linux上设置shell脚本开机启动")]),_:1})])])])])}const H=c(y,[["render",$],["__file","vuepress-auto-release.html.vue"]]);export{H as default};
